					...
					class CDependencyNode : public CProcessingTag {
						...
						public:
							...
							enum DEPENDENCNODEYTYPE {	DNTUNDEFINED, DNTINDEPENDENTBASE, DNTANDDEPENDENCY, DNTAUTOMATCHOOSEDEPENDENCY, DNTORDEPENDENCY, 
														...
														DNTREUSEBACKENDEXPANSIONMODESDEPENDENCY, DNTREUSEBACKENDFIXEDINDIVIDUALEXPANSIONDEPENDENCY, DNTREUSEBACKENDPRIORITIZEDINDIVIDUALEXPANSIONDEPENDENCY,
														DNTREUSEBACKENDVALUEDEPENDENCY
							};
